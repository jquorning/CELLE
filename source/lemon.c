...
void lemon_main (void)
{
  ...
  Symbol_init();
  State_init();
  lem.argv0         = lemon_program_name;
  lem.filename      = lemon_input_file;
  lem.basisflag     = lemon_basis_flag;
  lem.nolinenosflag = lemon_no_line_nos;
  Symbol_new("$");
